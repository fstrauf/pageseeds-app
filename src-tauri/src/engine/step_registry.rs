...
impl StepRegistry {
    pub fn new() -> Self {
        ...
        register_blocking!(
            handlers,
            StepKind::HubOutline,
            crate::engine::exec::content::hub_page::exec_hub_outline,
            agent_provider,
            context_json
        );
        ...
        register_blocking!(
            handlers,
            StepKind::HubWrite,
            crate::engine::exec::content::hub_page::exec_hub_write,
            agent_provider,
            context_json
        );
        ...
        handlers.insert(
            ...
            Box::new(|_step, ctx| {
                ...
                Box::pin(async move {
                    tokio::task::spawn_blocking(move || {
                        crate::engine::exec::content::hub_page::exec_hub_apply_draft(
                            &task,
                            &project_path,
                            &mdx_content,
                        )
