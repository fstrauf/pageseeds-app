...
Projects come from the PageSeeds operator SQLite DB (same as `pageseeds-cli`):
...
filesystem (or `pageseeds-cli list-projects` / `list-tasks` if you optionally enrich).
