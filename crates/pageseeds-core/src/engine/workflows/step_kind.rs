...
pub enum StepKind {
    ...
    /// Tool-calling content review investigation (falls back to recommend).
    ContentReviewInvestigate,
    ...
    CollectClarity,
    /// PostHog conversion tape collect (issue #308).
    CollectPosthog,
    ClaritySummarise,
    ClarityInvestigateAgentic,
...
impl StepKind {
    pub const fn as_str(&self) -> &'static str {
        match self {
            ...
            Self::ContentReviewInvestigate => "content_review_investigate",
            ...
            Self::IndexingFixGenerate => "indexing_fix_generate",
            Self::IndexingFixApply => "indexing_fix_apply",
            Self::IndexingFixVerify => "indexing_fix_verify",
            ...
            Self::CollectClarity => "collect_clarity",
            Self::CollectPosthog => "collect_posthog",
            Self::ClaritySummarise => "clarity_summarise",
            Self::ClarityInvestigateAgentic => "clarity_investigate_agentic",
...
impl FromStr for StepKind {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            ...
            "content_review_investigate" => Ok(Self::ContentReviewInvestigate),
            ...
            "indexing_fix_generate" => Ok(Self::IndexingFixGenerate),
            "indexing_fix_apply" => Ok(Self::IndexingFixApply),
            "indexing_fix_verify" => Ok(Self::IndexingFixVerify),
            ...
            "collect_clarity" => Ok(Self::CollectClarity),
            "collect_posthog" => Ok(Self::CollectPosthog),
            "clarity_summarise" => Ok(Self::ClaritySummarise),
            "clarity_investigate_agentic" => Ok(Self::ClarityInvestigateAgentic),
